...
<iframe src="{{ site.baseurl }}/magic_of_exponentials.pdf#view=FitH&navpanes=0" width="100%" height="900px" style="border: 2px solid #ddd; border-radius: 4px; width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; max-width: 100vw;">
  This browser does not support embedding PDFs. Please download the PDF to view it.
</iframe>
