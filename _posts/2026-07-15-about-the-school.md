...
The Meenakshi School has been created to support motivated students to explore the deep connections between mother nature, our universe, and science/mathematics. Some historians have commented on the "the unreasonable effectiveness of mathematics" in describing our world.  We really do not fuly know why mathematics, a human invention created for counting goats one might own etc. turns out to be means by which we understand the entire universe we inhabit!
